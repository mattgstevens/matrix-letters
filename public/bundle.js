...
var View = (function (options) {
  ...
  function render (state) {
    // return h('#messages', state.messages.map(function(msg) {
  ...
  function init (state) {
    ...
    var $chat = document.getElementById('stream')
    $chat.appendChild(DOM.rootNode)
  }
...
var Data = (function() {
  ...
  matrix.random('time for matrix', 0.8, 50, update);
  // matrix.random('time for matrix', 0.8, (1000/60), update);

})();

},{"./matrix-stream":3,"virtual-dom/create-element":4,"virtual-dom/diff":5,"virtual-dom/h":6,"virtual-dom/patch":14}],3:[function(require,module,exports){
...
},{"../vnode/handle-thunk":25,"../vnode/is-thunk":26,"../vnode/is-vnode":28,"../vnode/is-vtext":29,"../vnode/is-widget":30,"../vnode/vpatch":33,"./diff-props":35,"x-is-array":13}]},{},[2]);
